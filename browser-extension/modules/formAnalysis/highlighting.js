...
if (typeof formAnalysisHighlighting === 'undefined') {
  const formAnalysisHighlighting = (() => {
    ...
    function highlightFormControl(control, onContainerChange) {
      ...
      // Remove any existing navigation buttons first to avoid duplicates
      const existingButtons = container.querySelector('.fm-nav-buttons');
      if (existingButtons) {
      ...
      // Always add the navigation buttons to the container
      ...
      upButton.addEventListener('click', function(e) {
        ...
        if (currentContainer.parentElement && currentContainer.parentElement.tagName !== 'BODY') {
          ...
          // Remove any existing navigation buttons from the new container
          const existingButtons = currentContainer.querySelector('.fm-nav-buttons');
          if (existingButtons) {
            existingButtons.remove();
          }
